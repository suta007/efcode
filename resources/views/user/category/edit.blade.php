	...
	<div class="grid">
		<div class="mx-auto w-full lg:w-3/5">
			<div class="mb-3 flex justify-between rounded-md bg-white p-6 text-web-700 shadow-md">
				...
				<div class="text-xl font-bold text-web-700">แก้ไขหมวดหมู่</div>
				<div>
			...
			<div class="rounded-md bg-white py-4 px-8 shadow-md">
				<form action="{{ route('user.category.update', $data->id) }}" method="post" enctype="multipart/form-data">
					@csrf
					@method('PATCH')
					<x-input type="text" val="name" label="ชื่อหมวดหมู่" :value="old('name', $data->name)" class="col-span-3" lbcls="col-span-2" :errors="$errors" />
