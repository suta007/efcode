...
@section('content')
	...
	<x-div class="mx-auto px-5 col-12">
		...
		<form method="POST" action="{{ route('user.category.update', $data->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
			@method('PATCH')
			@csrf
			<div class="row mb-3">
				<label for="name" class="col-3 col-form-label text-md-end">Category</label>
				<div class="col-9">
